...
const InventoryListScreen: React.FC<InventoryListScreenProps> = ({ userName, initialBranch }) => {
    ...
    return (
        <div className="w-full h-full flex flex-col p-4 md:p-6 gap-6 overflow-hidden relative pb-[84px] md:pb-[100px]">
            {/* Header */}
            <div className="flex flex-col lg:flex-row justify-between lg:items-end gap-4 shrink-0">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-xl font-bold text-[#374151] uppercase tracking-tight">Бараа үлдэгдэл</h2>
                </div>
                <div className="flex items-center gap-3">
                    <PosExcelButton />
                </div>
            ...
            {/* Filters Area */}
            <div className="bg-white rounded-[24px] p-5 shadow-sm border border-gray-100 shrink-0 flex flex-col gap-6">
