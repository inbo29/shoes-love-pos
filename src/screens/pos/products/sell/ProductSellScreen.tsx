...
const ProductSellScreen: React.FC = () => {
    return (
        <div className="flex-1 flex flex-col h-full bg-[#F8F9FA]">
            <div className="w-full flex flex-col p-6 gap-6">
                ...
                <div className="bg-white rounded-2xl p-12 text-center shadow-lg border border-gray-100">
                    ...
                    <p className="text-gray-400 font-bold text-lg">Бараа зарах модуль</p>
                    <p className="text-gray-300 text-sm mt-2">Product Sales Module - Coming Soon</p>
                </div>
            </div>
        </div>
    );
